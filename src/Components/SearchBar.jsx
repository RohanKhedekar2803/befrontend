...
export default function SearchBar({setAllBooks,setLoading}) {
  ...
  return (
    <form className="flex items-center w-9/12 font-DMsans">
      ...
      <div className="relative w-full">
        ...
        <input
          ...
          type="text"
          id="simple-search"
          className=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2"
        />
      </div>
      <button
        type="submit"
